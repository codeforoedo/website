...
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/theme.css"></head>
<?php wp_head(); ?>
...
<div id="header">
	<div id="inner-header">
		<p id="sitetitle"><a href="/"><img src="<?php bloginfo('template_directory'); ?>/images/sitetitle.png" alt="code for oedo コード フォー 大江戸"></a></p>
	</div><!--/inner-header-->
	<div id="mainnav-area">
<!--
		<ul id="mainnav">
