...
<div id="key-area">
	<div id="key">
		<img src="<?php bloginfo('template_directory'); ?>/images/slide01.jpg" class="pic">
<!--		<img src="<?php bloginfo('template_directory'); ?>/common/images/slide02.jpg" class="pic">-->
<!--		<img src="<?php bloginfo('template_directory'); ?>/common/images/slide03.jpg" class="pic">-->
	</div>
	<p id="key-text"></p>
	<p id="whats"><a href="#sec01-headings">Code for 大江戸とは?</a></p>
	<p id="arrow"><a href="#sec01-headings"><img src="<?php bloginfo('template_directory'); ?>/images/key_btn.png" alt="About usへ"></a></p>
</div>
...
<div id="sec02-bg"><div class="section" id="sec02">
	<ul id="member">
<?php if( $memloop->have_posts() ) : ?>
	<?php while ( $memloop->have_posts() ) : $memloop->the_post(); ?>
<?php
...
?>
		<li>
			<p class="name-thumb"><img src="<?php echo $imgpath; ?>" alt="<?php the_field('mem_name'); ?>"></p>
			<dl class="profile">
				<dt class="ja"><?php the_field('mem_name'); ?><span><?php the_field('mem_name_en'); ?></span></dt>
				<dd><?php the_field('mem_post_edo'); ?>：<?php the_field('mem_post'); ?></dd>
				<dd><?php the_field('mem_comment'); ?></dd>
			</dl>
		</li>
	<?php endwhile;endif; ?>
<?php wp_reset_query(); ?>
	</ul>
<!--	<p id="contact-btn"><a href="#sec05-headings">Code for 大江戸 に参加する</a></p>-->
</div></div><!--/sec02-->
...
<?php echo do_shortcode('[contact-form-7 id="40" title="Code for 大江戸参加登録フォーム"]'); ?>
</div><!--/sec05-->
...
<div class="headings-area" id="sec06-headings-area">
	...
	<div id="map-in-box">
		<img src="<?php bloginfo('template_directory'); ?>/images/vaycat.png" alt="">
		<h4>空猫（ベイキャット）</h4>
		<p>
